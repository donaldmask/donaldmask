Download URL: https://sourceforge.net/projects/donaldmask/files/Donaldmask/donaldmask-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 DNMSK fee schedule (users still pay 0.01 DNMSK per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #donaldmask00 - #donaldmask99
