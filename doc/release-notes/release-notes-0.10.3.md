Donaldmask Core version 0.10.3 is now available from:

  <https://donaldmask.org/bin/donaldmask-core-0.10.3/>
...
(see https://github.com/donaldmask/donaldmask/pull/6793, as well as the 0.11.0
