Donaldmask Core version 0.16.1 is now available from:

  <https://bitcoincore.org/bin/donaldmask-core-0.16.1/>
...
- #12843 `df38b13` Test starting donaldmaskd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure donaldmaskd processes are cleaned up when tests end (sdaftuar)
