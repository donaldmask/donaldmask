Donaldmask Core version *0.15.0.1* is now available from:

  <https://donaldmask.org/bin/donaldmask-core-0.15.0.1/>

and

  <https://bitcoincore.org/bin/donaldmask-core-0.15.0.1/>
