Donaldmask version 0.5.4 is now available for download at:
http://sourceforge.net/projects/donaldmask/files/Donaldmask/donaldmask-0.5.4/
...
http://gitorious.org/donaldmask/donaldmaskd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Donaldmask-Qt notifications under Growl 1.3.
Increase required age of Donaldmask-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDonaldmask properly when installing Donaldmask-Qt over it. (Windows)
