Donaldmask Core version 0.13.2 is now available from:

  <https://donaldmask.org/bin/donaldmask-core-0.13.2/>
...
- #8908 `4a974b2` Update donaldmask-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow donaldmask-tx to create v2 transactions (dnmskdrak)
