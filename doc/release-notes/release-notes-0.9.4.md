Donaldmask Core version 0.9.4 is now available from:

  https://donaldmask.org/bin/0.9.4/
...
this update is incompatible with the Donaldmask system and could lead to consensus
forks.

Donaldmask Core released binaries from https://donaldmask.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~donaldmask/+archive/ubuntu/donaldmask
- A third-party or self-compiled Donaldmask Core

upgrade to Donaldmask Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
