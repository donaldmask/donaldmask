Donaldmask Core version 0.10.4 is now available from:

  <https://donaldmask.org/bin/donaldmask-core-0.10.4/>
...
- #6953 `43c2789` Split donaldmask-tx into its own package
- #6953 `dfe0d4d` Include donaldmask-tx binary on Debian/Ubuntu
