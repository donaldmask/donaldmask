Donaldmask-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/donaldmask/files/Donaldmask/donaldmask-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Donaldmask
...
New/changed settings (command-line or donaldmask.conf file)
--------------------------------------------------------
