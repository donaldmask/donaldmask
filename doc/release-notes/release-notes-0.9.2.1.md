Donaldmask Core version 0.9.2.1 is now available from:

  https://donaldmask.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 DNMSK to 0.01 DNMSK
...
- Fix "Start donaldmask on system login"
