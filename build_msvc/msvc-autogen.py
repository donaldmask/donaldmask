...
libs = [
    'libdonaldmask_cli',
    'libdonaldmask_common',
    'libdonaldmask_crypto',
    'libdonaldmask_node',
    'libdonaldmask_util',
    'libdonaldmask_wallet_tool',
    'libdonaldmask_wallet',
    'libdonaldmask_zmq',
    'bench_donaldmask',
    'libtest_util',
]
...
def parse_config_into_dnmsk_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"Donaldmask Core {version}\""

    with open(os.path.join(SOURCE_DIR,'../build_msvc/donaldmask_config.h.in'), "r", encoding="utf8") as template_file:
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/donaldmask_config.h'), "w", encoding="utf8") as dnmsk_config:
        dnmsk_config.writelines(template)
...
def main():
    parser = argparse.ArgumentParser(description='Donaldmask-core msbuild configuration initialiser.')
    ...
    parse_config_into_dnmsk_config()
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/donaldmask_config.h'), os.path.join(SOURCE_DIR, 'config/donaldmask-config.h'))
