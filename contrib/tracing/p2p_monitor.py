...
""" Interactive donaldmaskd P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Donaldmask Core can enable. It uses BCC
...
def main(donaldmaskd_path):
    ...
    donaldmaskd_with_usdts.enable_probe(
