...
"""Example logging Donaldmask Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/donaldmaskd
...
def main(donaldmaskd_path):
    ...
    b = BPF(text=program, usdt_contexts=[donaldmaskd_with_usdts])
