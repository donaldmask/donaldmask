...
complete --command donaldmaskd --no-files

# Extract options
function __fish_donaldmaskd_get_options
...
complete \
    --command donaldmaskd \
    --arguments "(__fish_donaldmaskd_get_options --nofiles)"
