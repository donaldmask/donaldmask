...
# Extract options
function __fish_donaldmask_tx_get_options
...
# Extract commands
function __fish_donaldmask_tx_get_commands
...
# Add options
complete \
    --command donaldmask-tx \
    --condition "not __fish_donaldmask_seen_cmd (__fish_donaldmask_tx_get_commands --commandsonly)" \
    --arguments "(__fish_donaldmask_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command donaldmask-tx \
    --arguments "(__fish_donaldmask_tx_get_commands)" \
    --no-files
