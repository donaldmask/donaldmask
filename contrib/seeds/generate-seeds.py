...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef DONALDMASK_CHAINPARAMSSEEDS_H\n')
    g.write('#define DONALDMASK_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the donaldmask network\n')
    ...
    g.write('#endif // DONALDMASK_CHAINPARAMSSEEDS_H\n')
