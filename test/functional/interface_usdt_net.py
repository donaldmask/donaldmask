...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/donaldmask/donaldmask/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(DonaldmaskTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our donaldmaskd node")
