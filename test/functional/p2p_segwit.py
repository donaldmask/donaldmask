...
class SegWitTest(DonaldmaskTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older donaldmaskd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let donaldmaskd fill it in.
