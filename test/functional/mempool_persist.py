...
By default, donaldmaskd will dump mempool on shutdown and
...
class MempoolPersistTest(DonaldmaskTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent donaldmaskd from writing mempool.dat to disk. Verify that `savemempool` fails")
