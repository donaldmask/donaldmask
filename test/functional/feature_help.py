...
"""Verify that starting donaldmask with -h works as expected."""

from test_framework.test_framework import DonaldmaskTestFramework
from test_framework.util import assert_equal

class HelpTest(DonaldmaskTestFramework):
    ...
    def run_test(self):
        self.log.info("Start donaldmask with -h for help text")
        ...
        self.log.info("Start donaldmask with -version for version information")
        ...
        self.log.info("Start donaldmaskd with -fakearg to make sure it does not start")
