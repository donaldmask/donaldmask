...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/donaldmask/donaldmask/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(DonaldmaskTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/donaldmask/donaldmask/blob/master/doc/tracing.md#tracepoint-validationblock_connected
