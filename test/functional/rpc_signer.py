...
Verify that a donaldmaskd node can use an external signer command.
...
class RPCSignerTest(DonaldmaskTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart donaldmaskd with -signer=<cmd>',
