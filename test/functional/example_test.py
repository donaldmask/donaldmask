...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the DonaldmaskTestFramework
    pass


class ExampleTest(DonaldmaskTestFramework):
    # Each functional test is a subclass of the DonaldmaskTestFramework class.
    ...
    def custom_method(self):
        ...
        DonaldmaskTestFramework class so other tests can use it."""
