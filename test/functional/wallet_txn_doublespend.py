...
class TxnMallTest(DonaldmaskTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 DNMSK:
        ...
        # First: use raw transaction API to send 1240 DNMSK to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 DNMSK coin each
        ...
        # Node0's balance should be starting balance, plus 50DNMSK for another
        ...
        # Node0's total balance should be starting balance, plus 100DNMSK for
