...
"""
Test starting donaldmaskd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(DonaldmaskTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that donaldmaskd has bound on "::1" (for RPC) and "::" (for P2P).
