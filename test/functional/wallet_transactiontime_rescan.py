...
class TransactionTimeRescanTest(DonaldmaskTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine DNMSK and create transactions
        ...
        # generate some dnmsk to create transactions and check blockcount
        ...
        # send 10 dnmsk to user's first watch-only address
        self.log.info('Send 10 dnmsk to user')
        ...
        # send 5 dnmsk to our second watch-only address
        self.log.info('Send 5 dnmsk to user')
        ...
        # send 1 dnmsk to our third watch-only address
        self.log.info('Send 1 dnmsk to user')
