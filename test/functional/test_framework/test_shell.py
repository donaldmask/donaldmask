...
class TestShell:
    """Wrapper Class for DonaldmaskTestFramework.

    The TestShell class extends the DonaldmaskTestFramework
    ...
    class __TestShell(DonaldmaskTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by DonaldmaskTestFramework child class.
            self.num_nodes = 1
