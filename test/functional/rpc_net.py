...
class NetTest(DonaldmaskTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=20174)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 20174)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=20174), {"success": False})
