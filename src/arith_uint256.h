...
#ifndef DONALDMASK_ARITH_UINT256_H
#define DONALDMASK_ARITH_UINT256_H
...
public:
     ...
     *
     * Donaldmask only uses this "compact" format for encoding difficulty
...
#endif // DONALDMASK_ARITH_UINT256_H
