...
#ifndef DONALDMASK_COMPAT_ASSUMPTIONS_H
#define DONALDMASK_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Donaldmask cannot be compiled without assertions."
#endif
...
#endif // DONALDMASK_COMPAT_ASSUMPTIONS_H
