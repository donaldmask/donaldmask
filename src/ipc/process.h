...
#ifndef DONALDMASK_IPC_PROCESS_H
#define DONALDMASK_IPC_PROCESS_H
...
//! IPC process interface for spawning donaldmask processes and serving requests
...
#endif // DONALDMASK_IPC_PROCESS_H
