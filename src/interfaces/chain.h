...
#ifndef DONALDMASK_INTERFACES_CHAIN_H
#define DONALDMASK_INTERFACES_CHAIN_H
...
//! internal workings of the donaldmask node, and not being very convenient to use.
//! Chain methods should be cleaned up and simplified over time. Examples:
//!
//! * The initMessages() and showProgress() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/donaldmask/donaldmask/pull/15288#discussion_r253321096).
//!
...
//!   node (https://github.com/donaldmask/donaldmask/issues/11756)
class Chain
{
public:
    virtual ~Chain() {}
...
#endif // DONALDMASK_INTERFACES_CHAIN_H
