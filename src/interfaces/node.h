...
#ifndef DONALDMASK_INTERFACES_NODE_H
#define DONALDMASK_INTERFACES_NODE_H
...
//! Top-level interface for a donaldmask node (donaldmaskd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or donaldmask.conf.
...
#endif // DONALDMASK_INTERFACES_NODE_H
