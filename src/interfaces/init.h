...
#ifndef DONALDMASK_INTERFACES_INIT_H
#define DONALDMASK_INTERFACES_INIT_H
...
//! (donaldmask-gui, donaldmask-node, donaldmask-wallet, donaldmaskd, donaldmask-qt) and each
...
#endif // DONALDMASK_INTERFACES_INIT_H
