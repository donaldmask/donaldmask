...
#ifndef DONALDMASK_TEST_SCRIPTNUM10_H
#define DONALDMASK_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Donaldmask Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // DONALDMASK_TEST_SCRIPTNUM10_H
