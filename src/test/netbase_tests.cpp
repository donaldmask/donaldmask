...
{
    BOOST_CHECK(TestSplitHost("www.donaldmaskcore.org", "www.donaldmaskcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.donaldmaskcore.org]", "www.donaldmaskcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.donaldmaskcore.org:80", "www.donaldmaskcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.donaldmaskcore.org]:80", "www.donaldmaskcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:20174", "127.0.0.1", 20174));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:20174", "127.0.0.1", 20174));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:20174", "::ffff:127.0.0.1", 20174));
    BOOST_CHECK(TestSplitHost("[::]:20174", "::", 20174));
    BOOST_CHECK(TestSplitHost("::20174", "::20174", 0));
    BOOST_CHECK(TestSplitHost(":20174", "", 20174));
    BOOST_CHECK(TestSplitHost("[]:20174", "", 20174));
    ...
    BOOST_CHECK(TestSplitHost("www.donaldmaskcore.org:65536", "www.donaldmaskcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.donaldmaskcore.org:0", "www.donaldmaskcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.donaldmaskcore.org:", "www.donaldmaskcore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:20174", "127.0.0.1:20174"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:20174", "[::]:20174"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
