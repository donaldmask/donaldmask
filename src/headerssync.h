...
#ifndef DONALDMASK_HEADERSSYNC_H
#define DONALDMASK_HEADERSSYNC_H
 ...
 *
 * The Donaldmask protocol does not offer an easy way to determine the work on a
...
#endif // DONALDMASK_HEADERSSYNC_H
