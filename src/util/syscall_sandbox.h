...
#ifndef DONALDMASK_UTIL_SYSCALL_SANDBOX_H
#define DONALDMASK_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during donaldmaskd initialization if Donaldmask Core was compiled
...
#endif // DONALDMASK_UTIL_SYSCALL_SANDBOX_H
