...
#ifndef DONALDMASK_UTIL_MESSAGE_H
#define DONALDMASK_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's donaldmask address, it must refer to a public key.
...
#endif // DONALDMASK_UTIL_MESSAGE_H
