...
#ifndef DONALDMASK_CRYPTO_CHACHA_POLY_AEAD_H
#define DONALDMASK_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@donaldmask.
 *
 ...
 *
 * The chacha20-poly1305@donaldmask combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@donaldmask cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@donaldmask are relatively fast in
...
#endif // DONALDMASK_CRYPTO_CHACHA_POLY_AEAD_H
