...
{
    // Test regression https://github.com/donaldmask/donaldmask/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/donaldmask-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/donaldmask-core/gui/pull/568.
    // With fListen=false in ~/.config/Donaldmask/Donaldmask-Qt.conf and all else left as default,
    // donaldmask-qt should set both -listen and -listenonion to false and start successfully.
