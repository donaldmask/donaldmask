...
//! Entry point for DonaldmaskApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &DonaldmaskApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for DonaldmaskGUI tests.
void AppTests::guiTests(DonaldmaskGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &DonaldmaskGUI::consoleShown, this, &AppTests::consoleTests);
