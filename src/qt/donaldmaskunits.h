...
#ifndef DONALDMASK_QT_DONALDMASKUNITS_H
#define DONALDMASK_QT_DONALDMASKUNITS_H
...
/** Donaldmask unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DonaldmaskUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DonaldmaskUnits(QObject *parent);

    /** Donaldmask units.
      @note Source: https://en.donaldmask.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        DNMSK,
        mDNMSK,
