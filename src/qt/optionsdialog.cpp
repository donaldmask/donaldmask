      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->donaldmaskAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->donaldmaskAtStartup);
    ...
    ui->donaldmaskAtStartup->setToolTip(ui->donaldmaskAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->donaldmaskAtStartup->setText(ui->donaldmaskAtStartup->text().arg(PACKAGE_NAME));

    ui->openDonaldmaskConfButton->setToolTip(ui->openDonaldmaskConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new DonaldmaskUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->donaldmaskAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSDNMSKontrols);
...
void OptionsDialog::on_openDonaldmaskConfButton_clicked()
{
