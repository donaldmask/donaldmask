...
#ifndef DONALDMASK_QT_GUIUTIL_H
#define DONALDMASK_QT_GUIUTIL_H
...
/** Utility functions used by the Donaldmask Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "donaldmask:" URI into recipient object, return true on successful parsing
