...
#ifndef DONALDMASK_WALLET_TRANSACTION_H
#define DONALDMASK_WALLET_TRANSACTION_H
...
public:
     ...
     * on this donaldmask node, and set to 0 for transactions that were created
...
#endif // DONALDMASK_WALLET_TRANSACTION_H
