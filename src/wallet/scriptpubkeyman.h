...
#ifndef DONALDMASK_WALLET_SCRIPTPUBKEYMAN_H
#define DONALDMASK_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Donaldmask Core wallet was originally a collection of unrelated private
...
#endif // DONALDMASK_WALLET_SCRIPTPUBKEYMAN_H
