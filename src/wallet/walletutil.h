...
#ifndef DONALDMASK_WALLET_WALLETUTIL_H
#define DONALDMASK_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! donaldmask from opening the wallet, thinking it was newly created, and
...
#endif // DONALDMASK_WALLET_WALLETUTIL_H
