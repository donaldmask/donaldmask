...
#ifndef DONALDMASK_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define DONALDMASK_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // DONALDMASK_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
