...
#ifndef DONALDMASK_SCRIPT_MINISCRIPT_H
#define DONALDMASK_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a donaldmask script
...
#endif // DONALDMASK_SCRIPT_MINISCRIPT_H
