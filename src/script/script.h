...
#ifndef DONALDMASK_SCRIPT_SCRIPT_H
#define DONALDMASK_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Donaldmask always counted CHECKMULTISIGs
...
#endif // DONALDMASK_SCRIPT_SCRIPT_H
