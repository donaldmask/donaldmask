...
#ifndef DONALDMASK_SCRIPT_STANDARD_H
#define DONALDMASK_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a donaldmask address
 */
...
/**
 * Generate a Donaldmask scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // DONALDMASK_SCRIPT_STANDARD_H
