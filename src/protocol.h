...
#ifndef DONALDMASK_PROTOCOL_H
#define DONALDMASK_PROTOCOL_H
...
/**
 * Donaldmask protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Donaldmask Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // Donaldmask Core nodes used to support this by default, without advertising this bit,
    ...
    // donaldmask-development mailing list. Remember that service bits are just
