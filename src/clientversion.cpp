 ...
 * for both donaldmaskd and donaldmask-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Donaldmask");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/donaldmask/bips/blob/master/bip-0014.mediawiki)
 */
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/donaldmask/donaldmask>";
