...
#ifndef DONALDMASK_NODE_CONNECTION_TYPES_H
#define DONALDMASK_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/donaldmask-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Donaldmask’s Peer-to-Peer Network")
...
#endif // DONALDMASK_NODE_CONNECTION_TYPES_H
