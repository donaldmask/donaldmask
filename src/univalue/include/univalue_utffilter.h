...
#ifndef DONALDMASK_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define DONALDMASK_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // DONALDMASK_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
