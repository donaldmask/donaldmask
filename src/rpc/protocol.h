...
#ifndef DONALDMASK_RPC_PROTOCOL_H
#define DONALDMASK_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in donaldmaskd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Donaldmask is not connected
...
#endif // DONALDMASK_RPC_PROTOCOL_H
